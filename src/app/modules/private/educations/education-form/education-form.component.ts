...
export class EducationFormComponent {
            ...
            if (this.idFormacion && this.idFormacion != '') {
              this.educationsService
                ...
                .subscribe((educations) => {
                  ...
                  if(this.education.fechaFinalizacion === null) this.coursingNowadays = true;
  ...
  onSubmit() {
    ...
    if(this.coursingNowadays) this.education.fechaFinalizacion = null
  ...
  onCoursingNowadaysClick(){
    this.coursingNowadays = !this.coursingNowadays;
    if(this.coursingNowadays) this.formEducationGroup.get('fechaFinalizacion')?.setValue(new Date(Date.now()));
    else this.formEducationGroup.get('fechaFinalizacion')?.setValue(null);
    console.log(this.coursingNowadays)
    console.log(this.formEducationGroup.get('fechaFinalizacion'))
