...
export class EducationComponent implements OnInit {
  ...
  education: Education[];
  constructor(private curriculumService:CurriculumService, private educationService: EducationService) {
    ...
    this.curriculumService.currentCurriculum$.subscribe(async curriculum => {
      ...
      if(curriculum.idCurriculum != 0){
        this.education = await this.educationService.getEducation(curriculum.idCurriculum);
      }
    })
